	...
	<nav class="p-5 pr-15 absolute right-10 top-2">
		<div class="flex justify-end items-center align-middle">
			...
			<div v-else>
				...
				<span @click="handleSignout" class="nav-link cursor-pointer">Sign out</span>
			</div>
		</div>
	</nav>
</template>
...
<style>
	...
	.sign-up-link {
		@apply ml-4 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-slate-200 bg-indigo-600 hover:bg-indigo-700
	}
</style>
